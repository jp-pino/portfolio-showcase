<nav class="hidden lg:flex items-center justify-end text-lg">
    ...
    <a title="{{ $page->siteName }} Homework" href="/blog/categories/homework/"
        class="ml-6 text-gray-700 hover:text-blue-600 {{ $page->isActive('/blog/categories/homework/') ? 'active text-blue-600' : '' }}">
        Homework
    </a>
